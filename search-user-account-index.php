								...
								<div class="col-md-12">
									...
									<div class="card mb-3" style="max-width: 540px;">
										<div class="row no-gutters">
											<div class="col-md-4 col-xl-4 col-8">
												<img src="'.$profile.'" class="img-responsive" alt="'.$u_name.'">
											</div>
											<div class="col-md-8 col-xl-8 col-4">
												<div class="card-body table-responsive">
													<h5 class="card-title" style="text-align:center;margin-bottom:15px;">'.$u_name.'</h5>
													<table class="card-text" style="width:90%;float:right;" border="1" cellspacing="2" cellpadding="2">
														';
														if($username!="")
														{
