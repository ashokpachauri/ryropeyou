   ...
   <head>
	...
	<body>
				...
				<div class="row">
					<main class="col col-xl-9 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
					  <div class="box shadow-sm border rounded bg-white mb-3 osahan-share-post">
						 <h5 class="pl-3 pt-3 pr-3 border-bottom mb-0 pb-3"><?php echo ucwords(strtolower($user_row['first_name'].' '.$user_row['last_name'])); ?>'s Mutual Connections</h5>
						 
						 <div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="mutual-bridge" onload="" role="tabpanel" aria-labelledby="bridge-tab">
		...
		<script>
			...
			LoadData('mutual-bridge','<?php echo $profile_user_id; ?>');
