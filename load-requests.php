...
<div class="p-3 user_section_requests">
	<div class="row">
        <div class="col-md-12">
            <h6>Incoming Connection Requests</h6>
        </div>
	<?php
		$friends=array();
	...
	?>
			 <div class="col col-6 col-lg-3" id="user_section_requests_<?php echo $connect_user_id; ?>">
				<b href="profile">
...
<script>
	loadImageSlider("user_section_requests");
</script>	
