<!doctype html>
<html lang="en">	<?php include_once 'head.php'; ?>	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
	<body>
    <div id="wrapper">		<?php //include_once 'main-sidebar.php'; ?>		<?php include_once 'header.php'; ?>
        <!-- contents -->		<?php
			if(!isset($_REQUEST['blogdata']) || $_REQUEST['blogdata']=="")
			{
				...
				<?php
			}			$is_blog_valid=false;			$blogdata=$_REQUEST['blogdata'];			$blog_query="SELECT * FROM users_blogs WHERE id='$blogdata' AND user_id='".$_COOKIE['blogger_id']."'";			$blog_result=mysqli_query($conn,$blog_query);			if(mysqli_num_rows($blog_result)>0)			{				$is_blog_valid=true;				$blog_row=mysqli_fetch_array($blog_result);			}
			else{
				?>
				<script>
