...
<html lang="en">
	...
	<?php
		if(!isset($_REQUEST['blogpostid']) || $_REQUEST['blogpostid']=="")
		{
			?>
			<script>
		...
		if(isset($_POST['save']))
		{
			...
			$query="UPDATE users_blogs_posts SET status='$publish'".$additional_query.",keywords='$keywords',blog_id='$blogdata',user_id='$user_id',added=NOW(),tags='$tags',title='$post_title',description='$meta_description',content='$post_content' WHERE id='$post_id'";
		...
		$blog_post_id=$_REQUEST['blogpostid'];
	?>
    ...
    <div id="wrapper">
		...
		<?php
			$is_blog_valid=false;
			$blog_query="SELECT * FROM users_blogs_posts WHERE id='$blog_post_id' AND user_id='".$_COOKIE['blogger_id']."'";
					...
					<div class="row">
						<div class="col-md-12">
							<form action="" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12" style="padding:20px;text-align:right;border:1px solid gray;border-radius:5px;box-shadow:1px 1px 1px 1px;">
										<h3 class="pull-left" style="float:left;">Start editing your blog post</h3>
									...
									<div class="col-md-12" style="border: 1px solid gray;border-top: none;margin-top: -27px;padding-top: 50px;">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<input type="hidden" name="blogdata" id="blogdata" value="<?php echo $blog_row['blog_id']; ?>">
													<input type="hidden" name="post_id" id="post_id" value="<?php echo $blog_row['id']; ?>">
													<h6>Post Title*</h6>
													<input type="text" class="form-control" value="<?php echo stripslashes($blog_row['title']); ?>" style="height:50px;border-radius:0px;" name="post_title" placeholder="Your post title..." required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea type="text" class="form-control" style="resize:none;" id="editor1" placeholder="Start writing here..." name="post_content"><?php echo stripslashes($blog_row['content']); ?></textarea>
										</div>
									</div>
								</div>
							</form>
