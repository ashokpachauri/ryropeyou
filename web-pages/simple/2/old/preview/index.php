...
<head>
    ...
    <meta name="author" content="RopeYou WebPages">
    <meta name="description" content="">
    <meta name="keywords" content="">


    <title>RopeYou  | WebPages</title>
...
<header id="home">
    <nav id="theMenu" class="menu">
        ...
        <div id="menu-options" class="menu-wrap">
            ...
            <a href="#blog"><i class="title-icon fa fa-pencil-square"></i>Posts</a>
        </div>
...
<section id="blog" class="section">
    <div class="container">
        <!-- SECTION TITLE -->
        <div class="section-title">
            <h4 class="text-uppercase text-center"><img src="../images/icons/post-it.png" alt="demo">Post</h4>
        </div>
