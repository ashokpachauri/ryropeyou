...
<head>
    ...
    <title>Ashok Kumar Pachauri</title>
    ...
    <div id="loading-center">
        <div id="loading-center-absolute">
            ...
            <div class="text-holder text-center">
                <h2>ASHOK K. PACHAURI</h2>
                <h6>Blogger, Poet & Software Developer</h6>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div id="v-card" class="card">
                    ...
                    <div id="profile" class="right">
                        ...
                        <img alt="profile-image" class="img-responsive" src="https://ropeyou.com/cut/uploads/AP9_MrjK18Do.jpg">
                        <div class="slant"></div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="info-headings">
                            <h4 class="text-uppercase left">ASHOK K. PACHAURI</h4>
                            <h6 class="text-capitalize left">Blogger, Poet & Software Developer</h6>
                        </div>
                    ...
                    <video id="html-video" class="video" poster="images/poster/poster.jpg" controls>
                        ...
                        <source src="https://ropeyou.com/cut/uploads/sample_cv.mp4" type="video/mp4">
                    </video>
...
<footer>
    <div class="container">
        <!--FOOTER DETAILS-->
        <p class="text-center">
            © Profile Pages All right reserved by
            <a href="https://ropeyou.com" target="_blank">
