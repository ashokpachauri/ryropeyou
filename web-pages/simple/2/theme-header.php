<header id="home">
    <nav id="theMenu" class="menu">
        <div id="menu-options" class="menu-wrap">
            <div class="logo-flat">
                <img alt="personal-logo" class="img-responsive" src="<?php echo $_THEME_BASE_URL; ?>images/profile/john.png">
            </div>
            <br>
			...
			<?php 
				foreach($_WEB_MENU as $_WMENU){
					?>
					<a href="#<?php echo $_WMENU['url']; ?>"><?php echo $_WMENU['small_text']; ?></a>
					<?php
				}
			?>
			<?php } ?>
