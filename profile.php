...
<html lang="en">
	<head>
		...
		<?php
			...
			$user_query="SELECT * FROM users WHERE username='$username' AND status=1";
		...
		?>
		<title><?php echo $user_row['first_name']." ".$user_row['last_name']; ?> |  RopeYou Connects</title>
	</head>
	<body>
					...
					<aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
						<div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
							<div class="py-4 px-3 border-bottom">
								...
								<img src="<?php echo $profile; ?>" class="img-fluid mt-2 rounded-circle" style="width:100px;" alt="<?php echo $user_row['first_name']." ".$user_row['last_name']; ?>">
								<h5 class="font-weight-bold text-dark mb-1 mt-4"><?php echo $user_row['first_name']." ".$user_row['last_name']; ?></h5>
								<p class="mb-0 text-muted"><?php $user_row['profile_title']; ?></p>
							</div>
							<div class="d-flex">
							...
							<div class="overflow-hidden border-top">
								<a class="font-weight-bold p-3 d-block" href="logout">Logout</a>
							</div>
						</div>
						 ...
						 <div class="box-body">
							<div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/l4.png" alt="">
							   </div>
							...
							<div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/l8.png" alt="">
							   </div>
							   <div class="font-weight-bold">
							...
							<div class="d-flex align-items-center osahan-post-header p-3 people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/l5.png" alt="">
							   </div>
							   <div class="font-weight-bold">
						...
						<div class="box shadow-sm border rounded bg-white mb-3">
						 ...
						 <div class="box-body p-3 border-bottom">
							<div class="d-flex align-items-top job-item-header pb-2">
							   ...
							   <img class="img-fluid ml-auto mb-auto" src="<?php echo base_url; ?>img/l6.png" alt="">
							</div>
						 ...
						 <div class="box-body p-3">
							<div class="d-flex align-items-top job-item-header pb-2">
							   ...
							   <img class="img-fluid ml-auto mb-auto" src="<?php echo base_url; ?>img/l2.png" alt="">
							</div>
					  ...
					  <div class="box shadow-sm border rounded bg-white mb-3">
						 ...
						 <div class="box-body p-3">
							<div class="d-flex align-items-top job-item-header pb-2">
							   ...
							   <img class="img-fluid ml-auto mb-auto" src="<?php echo base_url; ?>img/e2.png" alt="">
							</div>
					  ...
					  <div class="box shadow-sm border rounded bg-white mb-3">
						 ...
						 <div class="box-body p-3">
							<div class="d-flex align-items-center osahan-post-header mb-3 people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/p4.png" alt="">
							...
							<div class="d-flex align-items-center osahan-post-header mb-3 people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/p9.png" alt="">
								  <div class="status-indicator bg-success"></div>
							   </div>
							   <div class="font-weight-bold mr-2">
							...
							<div class="d-flex align-items-center osahan-post-header mb-3 people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/p10.png" alt="">
								  <div class="status-indicator bg-success"></div>
							   </div>
							   <div class="font-weight-bold mr-2">
							...
							<div class="d-flex align-items-center osahan-post-header mb-3 people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/p11.png" alt="">
								  <div class="status-indicator bg-success"></div>
							   </div>
							   <div class="font-weight-bold mr-2">
							...
							<div class="d-flex align-items-center osahan-post-header people-list">
							   <div class="dropdown-list-image mr-3">
								  <img class="rounded-circle" src="<?php echo base_url; ?>img/p12.png" alt="">
								  <div class="status-indicator bg-success"></div>
							   </div>
							   <div class="font-weight-bold mr-2">
						 ...
						 <div class="shadow-sm border rounded bg-white job-item mb-3">
							...
							<div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
							   <div class="overlap-rounded-circle">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p9.png" alt="" data-original-title="Sophia Lee">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p10.png" alt="" data-original-title="John Doe">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p11.png" alt="" data-original-title="Julia Cox">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p10.png" alt="" data-original-title="John Doe">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p11.png" alt="" data-original-title="Julia Cox">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p12.png" alt="" data-original-title="Robert Cook">
							   </div>
					  ...
					  <a href="job-profile.html">
						 <div class="shadow-sm border rounded bg-white job-item mb-3">
							<div class="d-flex align-items-center p-3 job-item-header">
							   ...
							   <img class="img-fluid ml-auto" src="<?php echo base_url; ?>img/l4.png" alt="">
							</div>
							<div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
							   <div class="overlap-rounded-circle">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p13.png" alt="" data-original-title="Sophia Lee">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p1.png" alt="" data-original-title="John Doe">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p2.png" alt="" data-original-title="Julia Cox">
								  <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="<?php echo base_url; ?>img/p3.png" alt="" data-original-title="Robert Cook">
							   </div>
							   <span class="font-weight-bold text-muted">18 connections</span>
							</div>
							<div class="p-3 job-item-footer">
