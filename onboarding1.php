...
<html lang="en">
   ...
   <body>
		<nav class="navbar navbar-expand navbar-dark bg-dark osahan-nav-top p-0">
			<div class="container">
				<a class="navbar-brand mr-2" href="dashboard" style="font-size:32px;color:#fff;font-weight:bold;"><!--<img src="img/logo.svg" alt="">-->RopeYou
				</a>
				...
				<ul class="navbar-nav ml-auto d-flex align-items-center">
				   ...
				   <li class="nav-item">
					  <a class="nav-link" href="dashboard"><i class="feather-clipboard mr-2"></i><span class="d-none d-lg-inline">Dashboard</span></a>
				   </li>
				   <li class="nav-item">
					  <a class="nav-link" href="broadcasts"><i class="feather-compass mr-2"></i><span class="d-none d-lg-inline">Broadcasts</span></a>
				   </li>
				   <li class="nav-item">
					  <a class="nav-link" href="bridge"><i class="feather-users mr-2"></i><span class="d-none d-lg-inline">My Bridge</span></a>
				   </li>
				   <li class="nav-item">
					  <a class="nav-link" href="jobs"><i class="feather-briefcase mr-2"></i><span class="d-none d-lg-inline">Jobs</span></a>
				   </li>
				   <li class="nav-item">
					  <a class="nav-link" href="blogger"><i class="feather-tablet mr-2"></i><span class="d-none d-lg-inline">Blogger</span></a>
				   </li>
				   <!--
				   ...
				   <li class="nav-item dropdown no-arrow ml-1 osahan-profile-dropdown">
					  ...
					  <div class="dropdown-menu dropdown-menu-right shadow-sm">
						 <div class="p-3 d-flex align-items-center">
							<div class="dropdown-list-image mr-3">
							   <img class="rounded-circle" src="<?php echo $profile; ?>" alt="">
							   <div class="status-indicator bg-success"></div>
							</div>
						 ...
						 <a class="dropdown-item" href="settings"><i class="feather-edit mr-1"></i> Edit Profile</a>
						 <a class="dropdown-item" href="pages"><i class="feather-aperture mr-1"></i> Pages</a>
						 <div class="dropdown-divider"></div>
		...
		<div class="vh-100">
         <div class="container">
            <div class="row align-items-center vh-100">
               ...
               <div class="col-md-6">
                  <svg class="w-100" id="fd59ce54-f850-4dfc-bc34-dd7d379d600e" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1074.392 584.231">
                     ...
                     <path d="M639.29619,342.07326c-.77711,3.19345-4.12792,5.751-7.83881,7.53791-7.80188,3.75682-17.4253,4.87788-26.7597,5.25418a45.17622,45.17622,0,0,1-7.1445-.132,20.5371,20.5371,0,0,1-12.25052-5.63141,1.68086,1.68086,0,0,1,.04371-2.84388c4.9694-5.45888,13.2622-8.80605,21.61613-11.21609,6.3344-1.82743,17.3813-6.56089,24.29013-5.9221C637.94444,329.73864,640.2774,338.04112,639.29619,342.07326Z" transform="translate(-63.054 -157.8845)" fill="#3f3d56"/>
                     ...
                     <path d="M604,527.2a4.93658,4.93658,0,0,1-1.32,3.392A4.33873,4.33873,0,0,1,599.5,532h-10a4.66433,4.66433,0,0,1-4.5-4.8,4.90458,4.90458,0,0,1,.82-2.74134A47.02,47.02,0,0,1,592.5,524a47.66454,47.66454,0,0,1,11.13,1.28A5.06656,5.06656,0,0,1,604,527.2Z" transform="translate(-63.054 -157.8845)" fill="#fff"/>
                     <circle cx="484.946" cy="308.1155" r="5" fill="#fff"/>
                     <circle cx="577.946" cy="308.1155" r="5" fill="#fff"/>
                     <circle cx="582.946" cy="355.1155" r="5" fill="#007bff" opacity="0.3"/>
                     <circle cx="460.946" cy="355.1155" r="5" fill="#007bff" opacity="0.3"/>
                  </svg>
               </div>
            </div>
         </div>
