<?php
	...
	if(isset($_POST['do_comment']))
	{
		...
		if($comment_text!="")
		{
			...
			$insert_query="INSERT INTO users_videos_comments SET user_id='$user_id',video_id='$video_id',comment_text='$comment_text',comment_id='$comment_id',type='$comment_type',added=NOW()";
			if(mysqli_query($conn,$insert_query))
			{
				$insert_id=mysqli_insert_id($conn);
				$response['status']="success";
				$comments_data_query="SELECT * FROM users_videos_comments WHERE video_id='$video_id' AND status=1 AND type='main' ORDER BY id DESC";
							...
							$recieved_html.='
									<div class="row">
										...
										<div class="col-md-2">
											<div class="control-group form-group">
												<div class="controls">
													<button type="button" data-bspid="'.$video_id.'" data-cid="" data-ct="'.$comment_type.'" name="do_comment" id="do_comment_0" onclick="doComment(0);" class="btn btn-success">Send</button>
												</div>
											</div>
										</div>
									</div>
						...
						$recieved_html.='<div class="media mb-4" id="comment_main_'.$comments_data_row['id'].'">
							...
							<div class="media-body">
								<div class="row">
									...
									if(isLogin() && isDeservingPostCommentUser($_COOKIE['uid'],$comments_data_row['id'],'users_videos_comments'))
									{
								...
								$sub_comments_query="SELECT * FROM users_videos_comments WHERE video_id='$video_id' AND comment_id='$comment_id' AND status=1 ORDER BY id ASC";
										...
										$recieved_html.='<div class="media mt-4" id="comment_child_'.$sub_comments_row['id'].'">
											...
											<div class="media-body">
												<div class="row">
													...
													if(isLogin() && isDeservingPostCommentUser($_COOKIE['uid'],$sub_comments_row['id'],'users_videos_comments'))
													{
														$recieved_html.='<div class="col-md-1">
										...
										$recieved_html.='
												<div class="row">
													...
													<div class="col-md-2">
														<div class="control-group form-group">
															<div class="controls">
																<button type="button" data-bspid="'.$video_id.'" data-cid="'.$comment_id.'" data-ct="'.$comment_type.'" onclick="doComment('.$sub_comment.');" name="do_comment" id="do_comment_'.$sub_comment.'" class="btn btn-success">Send</button>
															</div>
														</div>
													</div>
												</div>
										...
										$recieved_html.='<div class="media mt-4">
												...
												<div class="row">
													...
													<div class="col-md-2">
														<div class="control-group form-group">
															<div class="controls">
																<button type="button" data-bspid="'.$video_id.'" data-cid="'.$comment_id.'" data-ct="'.$comment_type.'" name="do_comment" id="do_comment_'.$comment_id.'" onclick="doComment('.$comment_id.');" class="btn btn-success">Send</button>
															</div>
														</div>
													</div>
												</div>
					...
					<div class="card-body">
									<div class="row">
										...
										<div class="col-md-2">
											<div class="control-group form-group">
												<div class="controls">
													<button type="button" data-bspid="'.$video_id.'" data-cid="" data-ct="'.$comment_type.'" name="do_comment" id="do_comment_y" onclick="doComment();" class="btn btn-success">Send</button>
												</div>
											</div>
										</div>
									</div>
	...
	else if(isset($_POST['update_comment']))
	{
		...
		if($comment_text!="")
		{
			...
			$insert_query="UPDATE users_videos_comments SET comment_text='$comment_text' WHERE id='$self_id'";
			if(mysqli_query($conn,$insert_query))
			{
				$response['status']="success";
				$comments_data_query="SELECT * FROM users_videos_comments WHERE video_id='$video_id' AND status=1 AND type='main' ORDER BY id DESC";
