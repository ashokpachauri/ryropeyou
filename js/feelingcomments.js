$(document).ready(function(){
	var last_html="";
	$(".ru-reaction-box-comment .feeling").on("click",function(){   // like click
		...
		$.ajax({
			url:base_url+'get-user-comment-like',
			type:'post',
			data:{comment_id:comment_id,data_feeling:data_feeling},
  ...
  $(".ru-reaction-box-comment .like-btn-text").on("click",function(){ // undo like click
	  if($(this).hasClass("active")){
		  ...
		  var comment_id= $(this).data("comment");
		  $.ajax({
			  url:base_url+'get-user-comment-unlike',
			  type:'post',
			  data:{comment_id:comment_id,data_feeling:data_feeling},
			  success:function(res){
