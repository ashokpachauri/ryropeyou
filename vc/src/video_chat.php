...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url; ?>vc/src/static/css/style.css">
    ...
    <script src="<?php echo base_url; ?>vc/src/static/js/auth.js"></script>
    <script src="<?php echo base_url; ?>vc/src/static/js/video.js"></script>
  </head>
  <body>
    <div class="container">
      <header>
