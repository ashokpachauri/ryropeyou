<?php
	...
	if(isset($_COOKIE['uid']) && $_COOKIE['uid']!="")
	{
		...
		$query="DELETE FROM users_languages WHERE user_id='$user_id' AND id='$language_id'";
		mysqli_query($conn,$query);
		$query="SELECT * FROM users_languages WHERE status=1 AND user_id='$user_id'";
		...
		{
			$htmlData="<div class='col-lg-12'><h6 style='text-align:center;'>No Languages has been added yet.</h6></div>";
		}
