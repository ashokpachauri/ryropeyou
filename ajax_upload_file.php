			...
			if($query)
			{
				...
				//----------------------------------------------------------------//
						...
						if($query->num_rows>0)
						{
							...
							$m_id=$row['id'];
							$q=$query="UPDATE users_profile_pics SET media_id='$media_id',user_id='$user_id',status=1,added=NOW(),type='$type',caption='$title' WHERE id='$m_id'";
							$query=$DB->query($query);
						...
						{
							$q=$query="INSERT INTO users_profile_pics SET media_id='$media_id',user_id='$user_id',status=1,added=NOW(),type='$type',caption='$title'";
							$query=$DB->query($query);
