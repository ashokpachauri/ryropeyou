...
(function ($, window, document, undefined) {
    ...
    var settings = {
        ...
        // Servers & channels
        signallingServer: "wss://209.20.89.197:1337", // or 'wss://209.20.89.197:1337'
        iceServers: null,
            ...
            try {
                n.GetUserMedia({
                    ...
                    function (stream) {
                        ...
                        $this.opts.localVideo[isMoz ? 'mozSrcObject' : 'srcObject'] = isMoz ? stream : stream;
						//w.webkitURL.createObjectURL(stream);
    ...
    var onRemoteStreamAdded = function ($this, event) {
        ...
        $this.opts.remoteVideo[isMoz ? 'mozSrcObject' : 'srcObject'] = isMoz ? $this.remoteStream : $this.remoteStream;
		//w.webkitURL.createObjectURL($this.remoteStream);
    ...
    var onRemoteStreamRemoved = function ($this, event) {
        ...
        $this.opts.remoteVideo[isMoz ? 'mozSrcObject' : 'srcObject'] = "";
        $this.remoteStream = null;
